...
# Plot Current
set terminal pngcairo nocrop enhanced font 'Verdana,10' size 1000,500 
set output '100kev_current_10.png'
...
clear
set terminal pngcairo nocrop enhanced font 'Verdana,10' size 1000,500 
set output '100kev_current_11.png'
...
clear
set terminal pngcairo nocrop enhanced font 'Verdana,10' size 1000,500 
set output '100kev_current_13.png'
...
clear
set terminal pngcairo nocrop enhanced font 'Verdana,10' size 1000,500 
set output '100kev_current_14.png'
...
set terminal pngcairo nocrop enhanced font 'Verdana,10' size 1000,500 
set output '100kev_track_flux_100.png'
...
clear
set terminal pngcairo nocrop enhanced font 'Verdana,10' size 1000,500 
set output '100kev_track_flux_101.png'
...
clear
set terminal pngcairo nocrop enhanced font 'Verdana,10' size 1000,500 
set output '100kev_track_flux_102.png'
...
clear
set terminal pngcairo nocrop enhanced font 'Verdana,10' size 1000,500 
set output '100kev_track_flux_103.png'
...
clear
set terminal pngcairo nocrop enhanced font 'Verdana,10' size 1000,500 
set output '100kev_track_flux_104.png'
