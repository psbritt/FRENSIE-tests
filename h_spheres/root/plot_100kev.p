...
plot "100kev_track_flux_1.txt" title "" with errorbars
clear
set terminal pngcairo nocrop enhanced font 'Verdana,10' size 1000,500 
...
set ylabel "Flux" 
#set arrow from 0,1 to 0.01,1 nohead
plot "100kev_track_flux_2.txt" title "" with errorbars
clear
set terminal pngcairo nocrop enhanced font 'Verdana,10' size 1000,500 
...
set ylabel "Flux" 
#set arrow from 0,1 to 0.01,1 nohead
plot "100kev_track_flux_4.txt" title "" with errorbars
clear
set terminal pngcairo nocrop enhanced font 'Verdana,10' size 1000,500 
...
set ylabel "Flux" 
#set arrow from 0,1 to 0.01,1 nohead
plot "100kev_track_flux_5.txt" title "" with errorbars
clear
