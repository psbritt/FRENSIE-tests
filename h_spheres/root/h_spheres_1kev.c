...
void h_sphere()
{
  ...
  TGeoManager* geom = new TGeoManager(
                   "h_sphere",
                   "Geometry for the electron H-1 sphere at room temp test prob.");
  ...
  void_cube_volume->SetUniqueID( 6 );
  ...
  // Place the hydrogen sphere inside of the void sphere
  void_sphere_volume->AddNode( h_sphere_volume1, 1 );
