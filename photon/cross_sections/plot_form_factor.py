...
if __name__ == "__main__":
    ...
    # Get the Waller-Hartree atomic form factor for Z=82
    momentum_grid_82 = native_data_82.getWallerHartreeAtomicFormFactorMomentumGrid()
    scattering_function_82 = native_data_82.getWallerHartreeAtomicFormFactor()

    # Get the Waller-Hartree atomic form factor for Z=13
    momentum_grid_13 = native_data_13.getWallerHartreeAtomicFormFactorMomentumGrid()
    scattering_function_13 = native_data_13.getWallerHartreeAtomicFormFactor()

    # Get the Waller-Hartree atomic form factor for Z=6
    momentum_grid_6 = native_data_6.getWallerHartreeAtomicFormFactorMomentumGrid()
    scattering_function_6 = native_data_6.getWallerHartreeAtomicFormFactor()

    # Plot the atomic form factor
    edge_thickness = 1.1
    ...
    plt.savefig("atomic_form_factors.eps")
    plt.show()
