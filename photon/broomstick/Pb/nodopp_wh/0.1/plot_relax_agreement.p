file1 = "atomic_relaxation_current"
set terminal post eps enh color
set output "facemc_mcnp_relax_current_agreement.eps"
...
plot file1 using 1:2 with boxes lc rgb"black" title "MCNP6", file1 using 1:4 with boxes lc rgb"red" title "FRENSIE"
#
...
plot file1 using 1:($4/$2) with points lc rgb"black" pt 7 ps 0.25, file1 using 1:($4/$2):6 with error lc rgb"black" lt 1 lw 1 pt 7 ps 0.25
#
unset multiplot