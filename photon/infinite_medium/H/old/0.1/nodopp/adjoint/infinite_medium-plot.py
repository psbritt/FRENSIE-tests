...
if __name__ == "__main__":
    ...
    if options.entity_id == 3:
        top_ylims = [0.0, 1.2]
        bottom_ylims = [0.5, 1.5]
        legend_pos = (0.95,0.95)
    if options.entity_id == 6:
        top_ylims = [0.0, 0.5]
        bottom_ylims = [0.5, 1.5]
        legend_pos = (0.95,0.95)
    if options.entity_id == 9:
        top_ylims = [0.0, 0.3]
        bottom_ylims = [0.5, 1.5]
        legend_pos = (0.95,0.95)
    if options.entity_id == 12:
        top_ylims = [0.0, 0.3]
        bottom_ylims = [0.5, 1.5]
        legend_pos = (0.95,0.95)
    elif options.entity_id == 15:
        top_ylims = [0.0, 0.3]
        bottom_ylims = [0.5, 1.5]
        legend_pos = (0.95,0.95)
    elif options.entity_id == 18:
        top_ylims = [0.0, 0.15]
        bottom_ylims = [0.5, 1.5]
        legend_pos = (0.95,0.95)
    elif options.entity_id == 21:
        top_ylims = [0.0, 0.075]
        bottom_ylims = [0.5, 1.5]
        legend_pos = (0.95,0.95)
    elif options.entity_id == 24:
        top_ylims = [0.0, 0.03]
        bottom_ylims = [0.5, 1.5]
        legend_pos = (0.95,0.95)
    elif options.entity_id == 27:
        top_ylims = [0.0, 0.005]
        bottom_ylims = [0.5, 1.5]
        legend_pos = (0.95,0.95)
