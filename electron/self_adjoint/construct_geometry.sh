...
echo "group 'estimator_4.cell.tl.flux.e*' add vol 1" >> temp_file
echo "group 'estimator_5.surface.flux.e*' add surface 1" >> temp_file
echo "group 'estimator_6.surface.current.e*' add surface 1" >> temp_file
